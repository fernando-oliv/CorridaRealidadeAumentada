...
def preprocess(path):
    ...
    result = np.ndarray((img_resized.shape[0], img_resized.shape[1], 4), dtype=np.uint8) #criando imagem com transparencia
    ...
    #esse threshold foi escolhido de forma empírica ao observar os valores obtidos com o gradiente
    threshold = 70
